                    ...
                    <form action="{{ route('products.store') }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="card-body">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="@error('sku') is-invalid @enderror form-control" placeholder="Sku" name="sku" value="{{ old('sku') }}">
                                @error('sku')
                                    <p class="invalid-feedback">{{ $message }}</p>
                                @enderror
                            </div>
                            <div class="mb-3">
                                ...
                                <input type="text" class="@error('price') is-invalid @enderror form-control" placeholder="Price" name="price" value="{{ old('price') }}">
                                @error('price')
                                    <p class="invalid-feedback">{{ $message }}</p>
                                @enderror
                            </div>
                            <div class="mb-3">
                                ...
                                <textarea rows="5" class="form-control">{{ old('name') }}</textarea>
                            </div>
                            <div class="mb-3">
